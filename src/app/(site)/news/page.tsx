      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            <TranslatedText text="Want to learn more about attention measurement?" />
          </h2>
          <p className="text-gray-600 mb-8">
            <TranslatedText text="Get in touch with our team to see how Lumen can help optimize your advertising performance." />
          </p>
          <Link href="/#contact">
            <Button size="lg">
