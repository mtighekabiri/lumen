      ...
      <section className="px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-2 border border-gray-200 rounded-2xl overflow-hidden">
            {/* Left — Lumen Media (text aligned right) */}
            <div className="flex flex-col items-end text-right p-10 sm:p-14 bg-gray-50">
              <h3 className="text-sm font-semibold tracking-widest text-[#01b3d4] uppercase">Lumen</h3>
              <p className="text-3xl sm:text-4xl font-bold text-gray-900 mt-1">Media</p>
              <p className="mt-4 text-gray-600 max-w-sm">
                Optimise your media investments with attention data.
                Buy smarter, measure better, and maximise every impression.
              </p>
              <Link href="/news">
            ...
            {/* Right — Lumen Creative (text aligned left) */}
            <div className="flex flex-col items-start text-left p-10 sm:p-14 border-t md:border-t-0 md:border-l border-gray-200">
              <h3 className="text-sm font-semibold tracking-widest text-[#01b3d4] uppercase">Lumen</h3>
              <p className="text-3xl sm:text-4xl font-bold text-gray-900 mt-1">Creative</p>
              <p className="mt-4 text-gray-600 max-w-sm">
                Design creatives that capture and hold attention.
                Test, iterate, and validate with real eye-tracking insights.
              </p>
              <Link href="/news">
                <Button variant="outline" className="mt-6">
                  Learn More
