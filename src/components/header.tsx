...
export function Header() {
  ...
  const navigation: NavItem[] = [
    { name: t(language, "nav.home"), href: "/" },
    {
      ...
      href: "/about",
      children: [
        { name: t(language, "nav.company"), href: "/about" },
        { name: t(language, "nav.team"), href: "/about/team" },
        { name: t(language, "nav.careers"), href: "/about/careers" },
      ],
    },
    {
      ...
      href: "/solutions",
      children: [
        { name: t(language, "nav.liveMeasurement"), href: "/solutions/live-measurement" },
        { name: t(language, "nav.audits"), href: "/solutions/audits" },
        {
          name: t(language, "nav.programmatic"),
          href: "/solutions/programmatic",
          children: [
            { name: t(language, "nav.planning"), href: "/solutions/programmatic/planning" },
            { name: t(language, "nav.buying"), href: "/solutions/programmatic/buying" },
            { name: t(language, "nav.activation"), href: "/solutions/programmatic/activation" },
          ],
        },
        { name: t(language, "nav.attentionStrategy"), href: "/solutions/attention-strategy-consulting" },
        { name: t(language, "nav.creativeTesting"), href: "/solutions/creative-testing" },
