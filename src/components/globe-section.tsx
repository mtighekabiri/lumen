  ...
  return (
    <>
      ...
      <div className="text-center mb-10">
        <h2 className="text-4xl sm:text-5xl font-bold tracking-tight text-[#01b3d4]">
      ...
      <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-4">
        {/* Left: Click history */}
        <div className="order-3 lg:order-1 w-full lg:w-[16%] shrink-0 lg:pt-14 lg:-ml-2">
        ...
        {/* Center: Globe */}
        <div className="order-1 lg:order-2 w-full lg:w-[44%] shrink-0">
          <Suspense
            fallback={
              <div className="w-full flex justify-center">
                <div className="w-[600px] h-[600px] max-w-full aspect-square rounded-full bg-gradient-to-br from-[#01b3d4]/10 to-[#01b3d4]/5 animate-pulse" />
        ...
        {/* Right: Copy */}
        <div className="order-2 lg:order-3 w-full lg:flex-1 flex flex-col gap-5 lg:pt-14 lg:pl-2">
